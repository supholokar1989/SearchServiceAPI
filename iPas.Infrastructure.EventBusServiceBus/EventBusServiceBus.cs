...
namespace iPas.Infrastructure.EventBusServiceBus
{
    public class EventBusServiceBus : IEventBus
    {
        ...
        private readonly string AUTOFAC_SCOPE_NAME = "ipas_event_bus";
        ...
        private async Task<bool> ProcessEvent(string eventName, string message)
        {
            ...
            if (_subsManager.HasSubscriptionsForEvent(eventName))
            {
                ...
                {
                    //string shortName = eventName.Replace(INTEGRATION_EVENT_SUFFIX, "");
